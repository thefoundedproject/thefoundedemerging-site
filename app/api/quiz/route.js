...
export async function POST(request) {
  try {
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'The Founded Project <quiz@thefoundedemerging.app>',
    ...
    await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'The Founded Project <hello@thefoundedemerging.app>',
        to: [email],
        ...
        html: `
          <div style="font-family:Georgia,serif;max-width:600px;margin:0 auto;padding:32px;background:#0F1B1F;color:#F5F0E8;">
            ...
            <a href="https://thefoundedemerging.app" style="display:inline-block;background:#D8AB69;color:#0F1B1F;padding:14px 32px;text-decoration:none;font-weight:700;border-radius:4px;">Explore the Work</a>
          </div>
        `,
      }),
    }).catch(() => {}); // non-fatal
