    ...
    <>
      <section style={{ backgroundColor: '#0F1B1F' }} className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-300 text-lg max-w-2xl">Open to students, youth organizations, leadership programs, and educators ready to bring this framework to young people who are ready for it.</p>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="space-y-6">
              {[
                ...
                { label: 'Youth Organization Leaders', desc: 'Bring the Human Enterprise framework to your program as a leadership and governance curriculum.' },
                { label: 'Institutional Partners', desc: 'Integrate Founded Emerging as a course, workshop series, or co-curricular offering at your school or institution.' },
              ].map((item) => (
