...
export const metadata = {
  ...
  description: 'Founded Emerging is the youth arm of The Founded Project. Human Enterprise Theory applied to emerging adults — high school, college, HBCUs, Alpha Phi Alpha, and youth organizations ready to lead.',
  keywords: 'Founded Emerging, youth leadership, emerging adult governance, Alpha Phi Alpha, HBCU, Human Enterprise Theory, youth development',
  openGraph: {
